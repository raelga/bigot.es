...
function envo_magazine_theme_info()
{
  ...
  $menu_title = esc_html__('Bigotes Theme', 'envo-magazine');

  add_theme_page(esc_html__('Bigotes Dashboard', 'envo-magazine'), $menu_title, 'edit_theme_options', 'et_magazine', 'envo_magazine_theme_info_page');
}
