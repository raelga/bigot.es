 ...
 * @package PT_Magazine
 */
if (!class_exists('envo_magazine_Image_Mix_Column_News')) :
   ...
   * @since 1.0.0
   */
  class envo_magazine_Image_Mix_Column_News extends WP_Widget
  {

    function __construct()
    {
      $opts = array(
        'classname'     => 'image-mix-news-section',
        'description'   => esc_html__('Widget to display news in mix columns layout. First post in full with overlay text and other in two columns', 'envo-magazine'),
      );

      parent::__construct('envo-magazine-image-mix-column-news', esc_html__('Envo Magazine: Image Mix Column News', 'envo-magazine'), $opts);
    }
      ...
      <div class="mix-col-section">
        ...
        <div class="inner-wrapper row">
          ...
          ?>
                ...
                <div class="news-item-1 col-md-12 split-images">
